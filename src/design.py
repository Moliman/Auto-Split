...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(812, 490))
        MainWindow.setMaximumSize(QtCore.QSize(812, 490))
        icon = QtGui.QIcon()
        ...
        self.similaritythresholdLabel.setGeometry(QtCore.QRect(10, 380, 91, 16))
        ...
        self.pauseLabel.setGeometry(QtCore.QRect(10, 430, 111, 16))
        ...
        self.screenshotLineEdit = QtGui.QLineEdit(self.centralwidget)
        self.screenshotLineEdit.setGeometry(QtCore.QRect(600, 300, 81, 20))
        self.screenshotLineEdit.setReadOnly(True)
        self.screenshotLineEdit.setObjectName(_fromUtf8("screenshotLineEdit"))
        self.setscreenshothotkeyButton = QtGui.QPushButton(self.centralwidget)
        self.setscreenshothotkeyButton.setGeometry(QtCore.QRect(690, 300, 71, 21))
        self.setscreenshothotkeyButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.setscreenshothotkeyButton.setObjectName(_fromUtf8("setscreenshothotkeyButton"))
        self.screenshotLabel = QtGui.QLabel(self.centralwidget)
        self.screenshotLabel.setGeometry(QtCore.QRect(500, 300, 61, 16))
        self.screenshotLabel.setObjectName(_fromUtf8("screenshotLabel"))
        self.bufferscreenshotLabel = QtGui.QLabel(self.centralwidget)
        self.bufferscreenshotLabel.setGeometry(QtCore.QRect(500, 330, 91, 16))
        self.bufferscreenshotLabel.setObjectName(_fromUtf8("bufferscreenshotLabel"))
        self.bufferScreenshotLineEdit = QtGui.QLineEdit(self.centralwidget)
        self.bufferScreenshotLineEdit.setGeometry(QtCore.QRect(600, 330, 81, 20))
        self.bufferScreenshotLineEdit.setReadOnly(True)
        self.bufferScreenshotLineEdit.setObjectName(_fromUtf8("bufferScreenshotLineEdit"))
        self.setbufferscreenshothotkeyButton = QtGui.QPushButton(self.centralwidget)
        self.setbufferscreenshothotkeyButton.setGeometry(QtCore.QRect(690, 330, 71, 21))
        self.setbufferscreenshothotkeyButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.setbufferscreenshothotkeyButton.setObjectName(_fromUtf8("setbufferscreenshothotkeyButton"))
        self.bufferScreenshotTotalImageSpinBox = QtGui.QDoubleSpinBox(self.centralwidget)
        self.bufferScreenshotTotalImageSpinBox.setGeometry(QtCore.QRect(760, 330, 44, 22))
        self.bufferScreenshotTotalImageSpinBox.setPrefix(_fromUtf8(""))
        self.bufferScreenshotTotalImageSpinBox.setDecimals(0)
        ...
        self.screenshotLineEdit.raise_()
        self.setscreenshothotkeyButton.raise_()
        self.screenshotLabel.raise_()
        self.bufferscreenshotLabel.raise_()
        self.bufferScreenshotLineEdit.raise_()
        self.setbufferscreenshothotkeyButton.raise_()
        self.bufferScreenshotTotalImageSpinBox.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.setscreenshothotkeyButton.setText(_translate("MainWindow", "Set Hotkey", None))
        self.screenshotLabel.setText(_translate("MainWindow", "Screenshot", None))
        self.bufferscreenshotLabel.setText(_translate("MainWindow", "Buffer screenshot", None))
        self.setbufferscreenshothotkeyButton.setText(_translate("MainWindow", "Set Hotkey", None))
